...
{
    /// <summary>
    /// An interactable that plays an audio clip when interacted via ray or direct interactor
    /// </summary>
    public class XRGripButtonWithAudio : XRBaseInteractable
    {
        [SerializeField]
        ...
        [SerializeField]
        [Tooltip("AudioSource that plays the sound")]
        ...
        void Start()
        {
            ...
            // Έλεγχος αν υπάρχει το AudioSource
